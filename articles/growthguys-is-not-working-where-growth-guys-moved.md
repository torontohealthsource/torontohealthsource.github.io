# growthguys.is Not Working? Growth Guys Moved to growthguys.com
...
Source: https://growthguyscanada.ca/articles/growthguys-is-not-working-where-growth-guys-moved.html · Updated: August 26, 2026 · TorontoHealth — educational only, not medical advice.
...
If you typed or clicked an old Growth Guys link and landed somewhere that looked slightly unfamiliar in the address bar, that was the redirect doing its job, not a hijack. We tested the old address on 28 July 2026: it forwards cleanly to *growthguys.com* and keeps everything after the slash intact.

## What people are actually running into

| What you saw | What it means |
| --- | --- |
| The address changed while the page loaded | Normal. That is the forward from the old domain to the new one |
| An old bookmark still opens the store | Normal, and it will keep working until the vendor retires the forward |
| A saved product link opens the right product | Normal. The forward carries the rest of the link with it |
| A page appears that asks for payment on a different domain | Stop. That is not the redirect behaving — close the tab and type the address yourself |

## What you should do about it

Here's the part most people skip: a redirect is not permanent. Vendors typically retire them once the move has settled, often after a year or two. Your bookmark works today and may quietly stop working later, at which point an old link will simply fail with no explanation.

So take thirty seconds now. Open your bookmark, let it forward, and re-save the page from the new address. Do the same for any Growth Guys link sitting in a note or a group chat.
...
- **growthguys.is is not broken** — it forwards to growthguys.com.

- **Re-save your bookmarks** to the new address rather than relying on the forward long-term.

- **Check the spelling** any time you arrive from a link you did not type yourself.

- **HEALTHYLIFE10 still gives 10% off.**
