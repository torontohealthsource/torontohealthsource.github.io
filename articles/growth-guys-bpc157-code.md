# BPC-157 Discount at Growth Guys: The Code, the Threshold, and the Small-Order Trap

_HEALTHYLIFE10 gives 10% off BPC-157 at Growth Guys (verified August 28, 2026). On small orders, the $350 CAD free-shipping threshold matters more — here's the math._
...
minimum order, verified at checkout in August 2026. On small orders the percentage is modest in
dollars — which is exactly why the free-shipping threshold matters more than most buyers think.

## The small-order math most BPC-157 buyers miss

BPC-157 is one of the lower-priced listings in most research catalogs, and small carts feel
cheap to discount: 10% off a $50 vial is $5. The lever that actually changes a small order's
total is shipping. At the August 2026 checkout test, Growth Guys showed a **$350.00 CAD
free-shipping threshold** — so a small BPC-157 order pays shipping, while a consolidated order
doesn't:

- Order under the threshold: 10% off subtotal, shipping added.

- Order over $350 CAD: 10% off subtotal, shipping free — the code and the threshold work together.

- Practical takeaway: batch your supplies (BAC water, syringes, other vials) into one order.

## What to verify on a BPC-157 listing before price-shopping

| Check | Why it outranks the discount |
| --- | --- |
| Batch COA (Janoshik or equivalent) | Purity claims without a current certificate are just labels |
| Batch number matches your vial | A COA for last year's batch proves nothing about yours |
| Domestic shipping | Border transit is the main cause of failed orders — see our [customs guide](/articles/peptides-canada-customs.html) |

Run any vendor — this one included — through the [vendor-vetting
quiz](/vendor-quiz.html) before you compare prices. A discount on an untested vial is not a discount.
