# Growth Guys Free Shipping: The $350 Threshold and How the Code Stacks (2026)

_Growth Guys free shipping is automatic over $350.00 CAD (verified August 28, 2026) — no code needed. How the threshold stacks with the 10% codes HEALTHYLIFE10, with real cart math._
...
live at checkout (verified August 28, 2026). There's no separate free-shipping code; the flat 10%
codes (HEALTHYLIFE10) reduce your subtotal, and the free-shipping threshold is
calculated on top. On small orders, clearing that threshold saves more than the code does.

## Is there a Growth Guys free-shipping code?
...
| --- | --- | --- |
| $120.00 CAD (one vial + water) | −$12.00 → $108.00 | Paid (under threshold) |
| $350.00 CAD (consolidated) | −$35.00 → $315.00 | **Free** |

The code and the free-shipping line work together — the code cuts the subtotal, the threshold
cuts the shipping. Consolidating supplies (BAC water, syringes, an extra vial) into one order that
clears $350 is usually the single biggest saving available.

## Does the free-shipping threshold apply before or after the code?

- The 10% code applies to your **subtotal**.

- The free-shipping threshold is assessed on the order value at checkout.

- Practical takeaway: build the cart to the threshold first, then apply a code — you keep free shipping and take 10% off.

## Is free shipping only in Canada?

Growth Guys is a Canada-focused domestic operation, so the free-shipping threshold and domestic
transit apply for Canadian orders — which also avoids the customs delays overseas vendors risk
(see the [customs guide](/articles/peptides-canada-customs.html)). For current US or
international shipping terms, check the store's shipping page directly.

Codes and their test dates: [the tested-codes list](/articles/growth-guys-codes-list.html); live proof in the [verification log](/verification-log.html).
...
**Can I get free shipping and 10% off together?** Yes — the threshold and a code stack (they affect different lines). One discount code per order, though.
