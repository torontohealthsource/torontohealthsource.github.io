...
The owned, canonical content hub for TorontoHealth — free educational guides on peptide testing transparency, vendor vetting, and a verified discount. Deploys free to GitHub Pages.

**Pages:** home (`index.html`), the COA guide, the discount page (with Offer schema), and the interactive vendor-vetting quiz. Plus `sitemap.xml` + `robots.txt` for fast indexing.
